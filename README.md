...
Sugarmagic is the planned unified host application for region authoring and runtime playback.

Its purpose is to replace the current split between Sugarbuilder and Sugarengine with one clean product and one rendering/runtime stack.
