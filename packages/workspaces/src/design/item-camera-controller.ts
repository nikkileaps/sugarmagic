...
export interface ItemCameraController {
  attach: (
...
export function createItemCameraController(): ItemCameraController {
  let controls: OrbitControls | null = null;
  let unsubscribeFrame: (() => void) | null = null;
  let contextMenuHandler: ((event: Event) => void) | null = null;
  let savedPosition = new THREE.Vector3(1.6, 1.2, 2.2);
  let savedTarget = new THREE.Vector3(0, 0.4, 0);
